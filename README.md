...
- **FPGA**: Coyote supports the following FPGA platforms: AMD Alveo U55C, U250, U280, U50 and, recently, V80 (currently without networking).
- **Vivado & Vitis**: 
  - For UltraScale+ devices (U55C, U250, U280, U50), Coyote requires Vivado 2022.1 or newer and has been tested extensively on all versions between 2022.1 and 2025.1. Prior versions should work but may require minor fixes. All network-related Coyote configurations are built using the UltraScale+ Integrated 100G Ethernet Subsystem, for which a valid license must be obtained.
